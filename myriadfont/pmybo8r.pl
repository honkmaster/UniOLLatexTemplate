(COMMENT font pmybo8r created by fontinst v1.929)

(COMMENT Filename: pmybo8r.pl)
(COMMENT Created by: tex driver)
(COMMENT Created using: \etxtopl{8r}{pmybo8r})

(COMMENT This file can be turned into a font with)
(COMMENT pltotf pmybo8r.pl pmybo8r.tfm)
...
(COMMENT END OF FILE pmybo8r.pl)
