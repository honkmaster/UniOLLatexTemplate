(COMMENT font pmyro8r created by fontinst v1.929)

(COMMENT Filename: pmyro8r.pl)
(COMMENT Created by: tex driver)
(COMMENT Created using: \etxtopl{8r}{pmyro8r})

(COMMENT This file can be turned into a font with)
(COMMENT pltotf pmyro8r.pl pmyro8r.tfm)
...
(COMMENT END OF FILE pmyro8r.pl)
